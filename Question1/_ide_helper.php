...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\CollectionMacroServiceProvider::mapOnly()
         * @param mixed $keys
         * @static 
         */ 
        public static function mapOnly($keys)
        {
                        return \Illuminate\Support\Collection::mapOnly($keys);
        }
                    /**
         * 
         *
         * @see \App\Providers\CollectionMacroServiceProvider::addAqlIndexed()
         * @static 
         */ 
        public static function addAqlIndexed()
        {
                        return \Illuminate\Support\Collection::addAqlIndexed();
        }
                    /**
         * 
         *
         * @see \App\Providers\CollectionMacroServiceProvider::mapAddAqlIndexed()
         * @static 
         */ 
        public static function mapAddAqlIndexed()
        {
                        return \Illuminate\Support\Collection::mapAddAqlIndexed();
        }
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\BuilderMacroServiceProvider::toSqlString()
         * @param bool $dd
         * @static 
         */ 
        public static function toSqlString($dd = false)
        {
                        return \Illuminate\Database\Eloquent\Builder::toSqlString($dd);
        }
                    /**
         * 
         *
         * @see \App\Providers\BuilderMacroServiceProvider::getRelationWithoutConstraints()
         * @param mixed $relation
         * @static 
         */ 
        public static function getRelationWithoutConstraints($relation)
        {
                        return \Illuminate\Database\Eloquent\Builder::getRelationWithoutConstraints($relation);
        }
                    /**
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\RouteServiceProvider::canAny()
         * @param array $abilities
         * @param mixed $models
         * @static 
         */ 
        public static function canAny($abilities, $models = [])
        {
                        return \Illuminate\Routing\Route::canAny($abilities, $models);
        }
                    /**
         * 
         *
         * @see \App\Providers\RouteServiceProvider::footprint()
         * @param array $arguments
         * @static 
         */ 
        public static function footprint($arguments)
        {
                        return \Illuminate\Routing\Route::footprint($arguments);
        }
     ...
     */ 
        ...
        public static function toSqlString($dd = false)
        {
                        return \Illuminate\Database\Query\Builder::toSqlString($dd);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\RedisMacroServiceProvider::useWrite()
         * @static 
         */ 
        public static function useWrite()
        {
                        return \Illuminate\Redis\Connections\Connection::useWrite();
        }
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\RuleServiceProvider::existsWithSource()
         * @param string $table
         * @param string $column
         * @static 
         */ 
        public static function existsWithSource($table, $column)
        {
                        return \Illuminate\Validation\Rule::existsWithSource($table, $column);
        }
...
namespace  { 
            ...
            class Eloquent extends \LaravelFreelancerNL\Aranguent\Eloquent\Model {}
